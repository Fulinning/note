...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_toast_scss__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_toast_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__css_toast_scss__);
...
/* harmony default export */ __webpack_exports__["a"] = ((text, time) => {
  new Toast(text, time)
});
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {function Waterfall($ct) {
  this.$ct = $ct
  this.init()
  this.render()
}
...
/* harmony default export */ __webpack_exports__["a"] = (($ct)=>{
  new Waterfall($ct)
});
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mob_toast_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_normalize_scss__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_normalize_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_normalize_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_main_scss__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mob_noteManage__ = __webpack_require__(14);
...
$.post('/api/note/init').done(function (ret) {
  ...
  if (ret.status === 0) {
    manage = new __WEBPACK_IMPORTED_MODULE_3__mob_noteManage__["a" /* default */](ret.data)
  } else {
    Object(__WEBPACK_IMPORTED_MODULE_0_mob_toast_js__["a" /* default */])('初始化失败！')
  }
})
...
$('header .add').on('click', function (e) {
  ...
  if (manage) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_mob_toast_js__["a" /* default */])('请先登录')
  }
})
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__note_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__toast_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__waterfall_js__ = __webpack_require__(4);
...
noteManage.prototype.init = function(data){
  if(data){
    $('.note-ct').empty()
    data.map((element)=>{
      Object(__WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */])(element)
    })
  }
  Object(__WEBPACK_IMPORTED_MODULE_1__toast_js__["a" /* default */])('初始化成功！')
}
noteManage.prototype.add = function(data){
  Object(__WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */])()
}
noteManage.prototype.sort = function(){
  Object(__WEBPACK_IMPORTED_MODULE_2__waterfall_js__["a" /* default */])($('.note-ct'))
}

/* harmony default export */ __webpack_exports__["a"] = (noteManage);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__toast_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_note_scss__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_note_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_note_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__waterfall_js__ = __webpack_require__(4);
...
Note.prototype = {
    ...
    $noteHead.find('.delete').on('click',function(){
      if(!_this.id){
        ...
        $.post('/api/note/delete',{id:_this.id}).done(function(ret){
          if(ret.status === 0){
            Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])('删除成功！')
            $note.remove()
          }else{
            Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])('删除失败！')
          }
        })
      }
    })
  ...
  addNote: function (text) {
    ...
    $.post('/api/note/add',{text}).done(function(ret){
      if(ret.status === 0){
        _this.id = ret.id
        Object(__WEBPACK_IMPORTED_MODULE_2__waterfall_js__["a" /* default */])($('.note-ct'))        
        Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])('添加成功！')
      }else{
        if(ret.err){
          Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])(err)
        }else{
          Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])('添加失败！')
        }
      }
    })
  },
  editNote:function(data){
    ...
    $.post('/api/note/edit',{
      ...
      if(ret.status === 0){
        Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])('修改成功！')
      }else{
        Object(__WEBPACK_IMPORTED_MODULE_0__toast_js__["a" /* default */])('修改失败！')
      }
    })
  }
